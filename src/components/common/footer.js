        ...
        <h1>
          <div className="logo">
            <i
              ...
              style={{ color: "#ff4c00", marginRight: "6px" }}
            ></i>
            &nbsp; Shahupuri Yuvak Mandal &nbsp;
          ...
          <ul className="socials ">
            ...
            <li>
              <a href="https://www.instagram.com/shahupuri_yuvak_mandal_sym/?hl=en">
                <i
          ...
          <div className="copyright">
            <h6>Designed and Developed by Akshay Hatkar</h6>
          </div>
        </h1>
